...
1. Text embedding generation using HuggingFace models (via LangChain)
...
class LLM:
    ...
    @staticmethod
    def generate_embedding(chunks: list[str]) -> list:
        """
    ...
    @staticmethod
    def invoke_llm(prompt: str, creativity: bool = False) -> str:
        """
        Invoke the language model to generate a response to the given prompt.

        Args:
            prompt (str): The prompt to send to the LLM.
            creativity (bool): Whether to use more creative generation.
